  ...
  <div class="p-4">
     <div class="grid grid-cols-3 my-4">
        ...
        <div class="col-start-3 text-right">            
            <button class="btn-sm bg-blue-600 text-white" @click="createUser()"><span class="material-icons mi-sm">add</span> New User</button>
        </div>
    </div>
  ...
  <form @submit.prevent="saveUser">
    <Modal :isOpen="isModalOpen" :widthClass="modalWidth">
      ...
      <template #body>
        ...
        <input v-model="newUser.username" type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required/>

        <label class="block mb-2 mt-4">Password</label>
        <input v-model="newUser.password" type="password" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required/>

        <!-- <label class="block mb-2 mt-4">Designation</label>
        <input v-model="newUser.designation" type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required/> -->
        
        <select v-model="newUser.designation" class="w-full px-4 py-2 mt-4 cursor-pointer border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
